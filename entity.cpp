...
entity::entity(QString name, int *stats, QString description): name_(name), description_(description){memcpy(stats_, stats, 9*sizeof (int));}
...
bool entity::valid(){return false;}
...
skill *entity::get_skill(int){return nullptr;}
short entity::get_type_of_eq(){return 0;}
int entity::get_counter(){return 0;}
void entity::decrease_counter(int){}
