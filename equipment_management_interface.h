...
private slots:
    ...
    void change_item_types();
    void use_item();
    void prepare_positions_switch();
    void switch_positions(entity*);
    //void close();
signals:
...
private:
    ...
    skill_choice_panel *skills_display;
    full_stats_display *stats_display_;
    items_display *items_display_;
    pc_equipment_display *pc_display_;
    QPushButton *switch_places_, *equip_or_use_, *turn_equipment_page_right_, *turn_equipment_page_left_, *switch_item_types_, *close_;
