...
skill::skill(const char *name, const char *description, short type, short base, short affected, int power, int cost) : name_(name), description_(description), base_power_(power), spcost_(cost), base_stat_(base), affected_stat_(affected), type_(type){}
